...
def Point_addition(eng):
    ...
    if(resource_check!=1):
        Round_constant_XOR(eng, x1, 0xabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdef, n)

    # Compiler-friendly implemenation (Comment or uncomment)
    x2 = Squaring_2_8(eng, x1, x2, n) # depth is 149, 11094 CNOT

    # Naive implementation (Comment or uncomment)
    # x3 = Squaring_2_8_slow(eng, x1, x3, n) # depth is 270, 11094 CNOT

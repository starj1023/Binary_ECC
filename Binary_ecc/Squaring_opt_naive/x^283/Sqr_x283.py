...
def Point_addition(eng):
    ...
    if (resource_check != 1):
        Round_constant_XOR(eng, x1,
                           0xabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefefabcdefabcdefabcdefabcdefabcdefabc, n)

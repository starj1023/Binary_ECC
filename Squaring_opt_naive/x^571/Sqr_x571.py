...
def Squraing_opt_naive(eng):
    ...
    if (resource_check != 1):
        Round_constant_XOR(eng, x1, 0xabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdeabcdefabcdefabcdefabcdefabcdefabcdefefabcdefabcdefabcdefabcdefabcdefafabcdefabcdefabcdefabcdefabcdefefabcdefabcdefabcdefabcdefabcdefabc, n)
